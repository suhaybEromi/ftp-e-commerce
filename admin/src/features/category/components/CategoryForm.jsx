import { categoryTranslate } from "../locale/category";
      ...
      <div dir={isRTL ? "rtl" : "ltr"} className="space-y-5">
        <div>
          <label className="mb-2 block text-sm font-medium text-slate-300">
            {categoryTranslate.categoryName[activeLang]}
          </label>
          <input
            type="text"
            placeholder="Enter category name"
            className={`w-full rounded-3xl border border-slate-700 bg-slate-800 px-4 py-3 text-white placeholder:text-slate-500 outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-700 ${
